           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li>
                    ...
                    <li>
                        <a  class="active-menu" href="/admin"><i class="fa fa-table fa-3x"></i> Admin</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3>admin</h3><a href="/admin" class="btn btn-primary">back</a> 
                                        <form  method="post" action="{{route('admin.update',[$admin->admin_id])}}" >
                                            {{ csrf_field() }}
                                        @method('put')
                                        <div class="form-group">
                                            <label>admin_fname</label>
                                                <input class="form-control" type="text" name="admin_fname" value="{{$admin->admin_fname}}">
                                                <label>admin_lname</label>
                                                <input class="form-control" type="text" name="admin_lname" value="{{$admin->admin_lname}}">
                                                <div class="form-group">
                                                <label>admin_phone</label>
                                                <input class="form-control" type="text" name="admin_phone" value="{{$admin->admin_phone}}">
                                                <div class="form-group">
                                                <label>admin_username</label>
                                                <input class="form-control" type="text" name="admin_username" value="{{$admin->admin_username}}">
                                                <div class="form-group">
                                                <label>admin_password</label>
                                                <input class="form-control" type="text" name="admin_password" value="{{$admin->admin_password}}">
                                    </div>
                                        </div>
                                            <div class="form-group">
