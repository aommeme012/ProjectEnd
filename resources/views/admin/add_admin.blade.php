                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3>Add Product</h3><a href="/admin" class="btn btn-primary">back</a> 
                                        <form role="form"  method="post" action="{{route('admin.store')}}">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                                <label>admin_fname</label>
                                                <input class="form-control" type="text" name="admin_fname">
                                                <label>admin_lname</label>
                                                <input class="form-control" type="text" name="admin_lname">
                                                <div class="form-group">
                                                <label>admin_phone</label>
                                                <input class="form-control" type="text" name="admin_phone">
                                                <div class="form-group">
