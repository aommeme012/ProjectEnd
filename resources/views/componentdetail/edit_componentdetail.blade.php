                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3>componentdetail</h3>
                                        <form  method="post" action="{{route('comde.update',[$comde->Comde_Id])}}" >
                                            {{ csrf_field() }}
                                        @method('put')
                                        <div class="form-group">
                                            <label>Comde_Amount</label>
                                            <input class="form-control" type="text" name="Comde_Amount" value = "{{$comde->Comde_Amount}}">
