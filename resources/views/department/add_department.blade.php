           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                    <a class="active-menu"  href="/dep"><i class="fa fa-dashboard fa-3x"></i>Departments</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap fa-3x"></i> Multi-Level</a>
                      </li>  
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3>Add Departments</h3><a href="/dep" class="btn btn-primary">back</a>    	
